...
menu_bar.add_cascade(label="Trò Chơi1", menu=vocabulary_menu3)
vocabulary_menu3.add_command(label="Trò chơi điền nghĩa", command=play_game1)

vocabulary_menu4 = Menu(menu_bar)
menu_bar.add_cascade(label="Trò Chơi2", menu=vocabulary_menu4)
vocabulary_menu4.add_command(label="Trò chơi nối từ vựng", command=play_game2)
