...
add_button = ttk.Button(button_frame1, image=phat_icon, text="Nghe âm thanh gốc", compound="top", cursor="hand2", command=play_original_audio_button)
add_button.grid(row=0, column=5, padx=10, pady=5)

# add_vocabulary_button = ttk.Button(button_frame1, text="Thêm từ vựng", command=open_add_vocabulary, style="Beautiful.TButton")
# add_vocabulary_button.grid(row=0, column=0, padx=10, pady=5, sticky="w")
# style = ttk.Style()
# style.configure("Beautiful.TButton", font=("Arial", 10), foreground="blue", width=15)
