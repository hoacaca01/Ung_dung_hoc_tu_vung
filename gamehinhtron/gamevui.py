...
frame = tk.Frame(window, width=500, height=500, bg="light gray")
...
text1 = canvas.create_text(circle1_x, circle1_y - circle1_radius - 10, text="Hoa1", fill="black",
                           font=("Helvetica", 12))
...
text2 = canvas.create_text(circle2_x, circle2_y - circle2_radius - 10, text="Hoa2", fill="black",
                           font=("Helvetica", 12))
...
def move_and_check_collision(event):
    ...
    if event.keysym == 'Up':
        ...
        circle1_radius += 5
        canvas.coords(circle1, circle1_x - circle1_radius, circle1_y - circle1_radius,
    ...
    if right1 >= left2 and left1 <= right2 and bottom1 >= top2 and top1 <= bottom2:
        if collision_message_id is None:
            ...
            collision_message_id = canvas.create_text(200, 20, text="Hoa1 va chạm với Hoa2!", fill="black",
                                                     font=("Helvetica", 12))
